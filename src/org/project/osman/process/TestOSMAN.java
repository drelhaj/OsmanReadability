...
public class TestOSMAN {
		...
		public static void main(String[] args) throws ClassNotFoundException, Exception{
			//the following data load only works if you decided to use Stanford splitter. You can ignore it for now.
			osman.loadData();
		
		//Osman works better with Diacritised text. If your text doesn't contain any diacritics, Osman will estimate that for you and still provide a close output.
		...
		//String harderText = "كشفت دراسة أجرتها بي بي سي. إن تكلفة مشاهدة مباريات كرة القدم في بريطانيا انخفضت أو ظلت على ما هي عليه لغالبية مشجعي اللعبة.";
		System.out.println(harderText);
		double osmanScore2 = osman.calculateOsman(harderText);
		...
		System.out.println(hardText);
		double osmanScore1 = osman.calculateOsman(hardText);
